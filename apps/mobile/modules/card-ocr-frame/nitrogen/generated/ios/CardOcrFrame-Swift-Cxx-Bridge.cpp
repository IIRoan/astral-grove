///
/// CardOcrFrame-Swift-Cxx-Bridge.cpp
...
namespace margelo::nitro::cardocr::bridge::swift {
  ...
  std::shared_ptr<HybridCardOcrFrameSpec> create_std__shared_ptr_HybridCardOcrFrameSpec_(void* NON_NULL swiftUnsafePointer) noexcept {
    ...
    return std::make_shared<margelo::nitro::cardocr::HybridCardOcrFrameSpecSwift>(swiftPart);
  }
  void* NON_NULL get_std__shared_ptr_HybridCardOcrFrameSpec_(std__shared_ptr_HybridCardOcrFrameSpec_ cppType) {
    std::shared_ptr<margelo::nitro::cardocr::HybridCardOcrFrameSpecSwift> swiftWrapper = std::dynamic_pointer_cast<margelo::nitro::cardocr::HybridCardOcrFrameSpecSwift>(cppType);
    #ifdef NITRO_DEBUG
    if (swiftWrapper == nullptr) [[unlikely]] {
      throw std::runtime_error("Class \"HybridCardOcrFrameSpec\" is not implemented in Swift!");
    }
    #endif
    CardOcrFrame::HybridCardOcrFrameSpec_cxx& swiftPart = swiftWrapper->getSwiftPart();
